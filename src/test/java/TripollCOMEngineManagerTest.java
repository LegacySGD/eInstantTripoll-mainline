...
public class TripollCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(TripollCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/TripollIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/TripollIW/InitOutcome.xml").getDocumentElement();
	...
	//@Ignore
	@Test
	public void test_buy_200x_2400000CreditsWin_RevealThreeTimes()
		throws Exception
	{
		Element playerInput;
		int pricePoint = 200;
		...
		assertEquals("Wager", JXPathUtil.getString(outcome, "//NextStage/text()"));
		assertSettledPendingPayout(outcome, pricePoint, 0, 2400000);
	}
	...
	//@Ignore
	@Test
	public void test_try_200x_2400000CreditsWin()
			throws Exception
	{
		Element playerInput;
		int pricePoint = 200;
